...
const Footer = () => {
  return (
    <footer className="bg-[#0f172a] text-slate-400 font-sans border-t border-slate-800/50 relative overflow-hidden">
      ...
      <div className="max-w-400 mx-auto px-6 lg:px-16 pt-20">
      ...
      <div className="max-w-400 mx-auto px-6 lg:px-16 py-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 relative z-10">
        {/* Brand Section */}
      ...
      <div className="border-t border-slate-800/50 py-10 bg-slate-950/30 backdrop-blur-md">
        <div className="max-w-400 mx-auto px-6 lg:px-16 flex flex-col md:flex-row justify-between items-center gap-8">
